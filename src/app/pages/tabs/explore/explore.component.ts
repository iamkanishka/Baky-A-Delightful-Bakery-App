...
export class ExploreComponent {
  ...
  coverImage: string =
    "https://images.pexels.com/photos/1721934/pexels-photo-1721934.jpeg?cs=srgb&dl=pexels-zvolskiy-1721934.jpg";
  ...
  checkOrientation(): void {
    ...
    this.thumbnailWidth = this.screenWidth * 0.9;

    this.imageAspect = this.isPortrait ? "aspectFit" : "aspectFit";
    this.thumbnailBottomPadding = this.isPortrait
